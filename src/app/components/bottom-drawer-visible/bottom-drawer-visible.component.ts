...
@Component({
    ...
    templateUrl: './bottom-drawer-visible.component.html',
    styleUrl: './bottom-drawer-visible.component.scss'
})
export class BottomDrawerVisibleComponent implements OnChanges, AfterViewInit {
